...
if (class_exists('LLMS_Payment_Gateway')) {
    final class Lkn_Payment_Banking_Slip_Pix_For_Lifterlms_Pix_Settings {
        public static function pix_settings_fields($default_fields, $gateway_id) {
            $gateway = Lkn_Payment_Banking_Slip_Pix_For_Lifterlms_Helper::get_gateways( 'pix' );

            $fields = array();

            // Field for Payment instructions.
            $fields[] = array(
                'id' => $gateway->get_option_name( 'lkn_payment_payment_instructions' ),
            ...
            $fields[] = array(
                'id' => $gateway->get_option_name( 'lkn_payment_api_key' ),
            ...
            $fields[] = array(
                'id' => $gateway->get_option_name( 'lkn_payment_token_key' ),
            ...
            $fields[] = array(
                'id' => $gateway->get_option_name( 'lkn_payment_days_due_date' ),
            ...
            $fields[] = array(
                'id' => $gateway->get_option_name( 'lkn_payment_auto_payment_capture' ),
